...
public class animated extends AppCompatActivity {
    ...
    private final String url_api="https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=1&sort_by=popularity.desc&with_genres=16&api_key=ada074b6a5691631b70bfbcaf68ebad9";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.animated), (v, insets) -> {
        ...
        display.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Glide.with(animated.this).load(movies.get(win).getImages(tr++)).into(display);
            }
        });
        ...
        op1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(animated.this, ganaste.class);
